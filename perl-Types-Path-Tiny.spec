...
License  : Apache-2.0
Requires: perl-Types-Path-Tiny-license
Requires: perl-Types-Path-Tiny-man
...
%package man
Summary: man components for the perl-Types-Path-Tiny package.
Group: Default

%description man
man components for the perl-Types-Path-Tiny package.
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/perl-Types-Path-Tiny
cp LICENSE %{buildroot}/usr/share/doc/perl-Types-Path-Tiny/LICENSE
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/Types/Path/Tiny.pm

%files license
%defattr(-,root,root,-)
/usr/share/doc/perl-Types-Path-Tiny/LICENSE
